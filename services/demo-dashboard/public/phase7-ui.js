...
const REASON_LABELS = Object.freeze({
  ...
  CATEGORY_PROCUREMENT_EVIDENCE_REQUIRED:['尚未确认该公司经营目标类目','Company category is not confirmed'],
  CATEGORY_CONFIRMATION_REQUIRED:['尚未确认该公司经营目标类目','Company category is not confirmed'],
...
const FIELD_LABELS = Object.freeze({
  ...
  category_procurement_match:['目标类目匹配','Target Category Match'], supplier_access:['历史准入资料','Historical access data'],
